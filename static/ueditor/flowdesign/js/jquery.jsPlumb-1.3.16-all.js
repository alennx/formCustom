jsPlumbUtil = {
    ...
    pointOnLine: function(a, e, b) {
        var d = jsPlumbUtil.gradient(a, e),
        i = jsPlumbUtil.segment(a, e),
        h = b > 0 ? jsPlumbUtil.segmentMultipliers[i] : jsPlumbUtil.inverseSegmentMultipliers[i],
        c = Math.atan(d),
        f = Math.abs(b * Math.sin(c)) * h[1],
        g = Math.abs(b * Math.cos(c)) * h[0];
        return {
            x: a.x + g,
            y: a.y + f
        }
    ...
    perpendicularLineTo: function(c, d, e) {
        var b = jsPlumbUtil.gradient(c, d),
        f = Math.atan( - 1 / b),
        g = e / 2 * Math.sin(f),
        a = e / 2 * Math.cos(f);
        return [{
        ...
        this.fire = function(g, h, d) {
            if (c[g]) {
                for (var f = 0; f < c[g].length; f++) {
                    if (jsPlumbUtil.findWithFunction(a,
                    function(i) {
                        return i === g
                    }) != -1) {
                        c[g][f](h, d)
    ...
    var c = function(i) {
                ...
                if (u) {
                    for (var r = 0; r < u.childNodes.length; r++) {
                        if (u.childNodes[r].nodeType != 3) {
                            var t = m.getElementObject(u.childNodes[r]),
                            v = i.getId(t, null, true);
                            if (v && e[v] && e[v] > 0) {
                                var s = m.getOffset(t);
                                f[p][v] = {
                                    id: v,
        ...
        this.updateOffsets = function(o) {
            var r = jsPlumb.CurrentLibrary,
            m = r.getElementObject(o),
            l = i.getId(m),
            n = f[l],
            k = r.getOffset(m);
            if (n) {
                for (var q in n) {
                    var s = r.getElementObject(q),
                    p = r.getOffset(s);
                    f[l][q] = {
                        id: q,
                        offset: {
    ...
    window.jsPlumbAdapter = {
        ...
        setRenderMode: function(i) {
            ...
            if (i) {
                i = i.toLowerCase();
                var f = this.isRenderModeAvailable("canvas"),
                e = this.isRenderModeAvailable("svg"),
    ...
    var g = jsPlumbUtil.findWithFunction,
    G = jsPlumbUtil.indexOf,
    A = jsPlumbUtil.removeWithFunction,
    k = jsPlumbUtil.remove,
    r = jsPlumbUtil.addWithFunction,
    i = jsPlumbUtil.addToList,
    l = jsPlumbUtil.isArray,
    z = jsPlumbUtil.isString,
    u = jsPlumbUtil.isObject;
    var v = null,
    c = function(H, I) {
    ...
    o = jsPlumbUtil.log,
    F = jsPlumbUtil.group,
    f = jsPlumbUtil.groupEnd,
    E = jsPlumbUtil.time,
    t = jsPlumbUtil.timeEnd,
    p = function() {
    ...
    x = function(M) {
        ...
        var K = function(X) {
            ...
            if (l(X)) {
                ...
                if (X.constructor == String) {
                    V = new n.Overlays[S._jsPlumb.getRenderMode()][X]({
                        component: S,
                        _jsPlumb: S._jsPlumb
                    })
                } else {
        ...
        this.setLabel = function(T) {
            ...
            if (!U) {
                var V = T.constructor == String || T.constructor == Function ? {
                    label: T
                }: T;
                U = R(V);
    ...
    var w = function(I) {
        ...
        be = function(bB, bD, bC) {
            if (!jsPlumbAdapter.headless && !a9) {
                var bE = c(bB, "id"),
                bz = br.dragManager.getElementsForDraggable(bE);
                if (bC == null) {
                    bC = p()
                }
            ...
            if (!jsPlumbAdapter.headless) {
                ...
                if (bI) {
                    if (bE.isDragSupported(bD) && !bE.isAlreadyDraggable(bD)) {
                        ...
                        bH = n.extend({},
                        bH);
                        var bF = bE.dragEvents.drag,
                        bA = bE.dragEvents.stop,
                        bC = bE.dragEvents.start;
                        bH[bC] = ap(bH[bC],
                        function() {
        ...
        af = function(bD) {
            var bC = br.Defaults.ConnectionType || br.getDefaultConnectionType(),
            bB = br.Defaults.EndpointType || ah,
        ...
        ay = function(bB) {
            if (bB.container) {
                ...
                var bz = n.CurrentLibrary.getTagName(bB.source),
                bA = n.CurrentLibrary.getParent(bB.source);
        ...
        this.addEndpoint = function(bC, bD, bM) {
            ...
            bC = aL(bC);
            var bE = [],
            bH = bC.length && bC.constructor != String ? bC: [bC];
        ...
        var ba = function(bC, bE, bz) {
            var bB = br.Defaults.ConnectionType || br.getDefaultConnectionType(),
            bA = bC.constructor == bB,
            bD = bA ? {
                connection: bC,
                source: bC.source,
                target: bC.target,
        ...
        this.detach = function() {
            ...
            var bD = br.Defaults.ConnectionType || br.getDefaultConnectionType(),
            bE = arguments[0].constructor == bD,
            bC = arguments.length == 2 ? bE ? (arguments[1] || {}) : arguments[0] : arguments[0],
            bH = (bC.fireEvent !== false),
            bB = bC.forceDetach,
            bA = bE ? arguments[0] : bC.connection;
            if (bA) {
        ...
        this.getConnections = function(bI, bA) {
            ...
            var bH = bI.scope || br.getDefaultScope(),
            bG = bv(bH, true),
            bz = bv(bI.source),
            bE = bv(bI.target),
            bD = (!bA && bG.length > 1) ? {}: [],
        ...
        this.selectEndpoints = function(bH) {
            bH = bH || {};
            bH.scope = bH.scope || "*";
            var bM = !bH.element && !bH.source && !bH.target,
            bA = bM ? "*": bv(bH.element),
            bB = bM ? "*": bv(bH.source),
            bJ = bM ? "*": bv(bH.target),
            bO = bv(bH.scope, true);
                ...
                if (bD || bz || bK) {
                    inner: for (var bI = 0; bI < aV[bF].length; bI++) {
                        ...
                        if (aI(bO, bL.scope, true)) {
                            var bN = (bE && bB.length > 0 && !bL.isSource),
                            bG = (bC && bJ.length > 0 && !bL.isTarget);
                            if (bN || bG) {
                                continue inner
                            }
                            bP.push(bL)
        ...
        this.init = function() {
            if (!K) {
                ...
                var bz = function(bA) {
                    n.CurrentLibrary.bind(document, bA,
                    function(bG) {
        ...
        this.makeTarget = function(bC, bD, bJ) {
            ...
            n.extend(bA, bD);
            ac(bA, 1);
            var bH = n.CurrentLibrary,
            bI = bA.scope || br.Defaults.Scope,
            bE = !(bA.deleteEndpointsOnDetach === false),
            bB = bA.maxConnections || -1,
            bz = bA.onMaxConnections;
            _doOne = function(bO) {
                var bM = H(bO);
                a1[bM] = bA;
                bl[bM] = bA.uniqueEndpoint,
                at[bM] = bB,
                am[bM] = true,
                proxyComponent = new B(bA);
                var bL = n.extend({},
                bA.dropOptions || {}),
                bK = function() {
                    var bR = n.CurrentLibrary.getDropEvent(arguments),
                    bT = br.select({
                        target: bM
                    }).length;
                    br.currentlyDragging = false;
                    var b3 = C(bH.getDragObject(arguments)),
                    bS = c(b3, "dragId"),
                    b1 = c(b3, "originalScope"),
                    bY = bk[bS],
                    bQ = bY.endpoints[0],
                    bP = bA.endpoint ? n.extend({},
                    bA.endpoint) : {};
                    ...
                    if (bW) {
                        ...
                        if (b2.anchor.positionFinder != null) {
                            var bZ = bH.getUIPosition(arguments, br.getZoom()),
                            bV = s(bO, br),
                            b0 = a(bO),
        ...
        this.makeSource = function(bD, bE, bI) {
            ...
            ac(bB, 0);
            var bH = n.CurrentLibrary,
            bC = bB.maxConnections || -1,
            bA = bB.onMaxConnections,
            bz = function(bQ) {
                var bK = H(bQ),
                bR = bB.parent,
                bJ = bR != null ? br.getId(bH.getElementObject(bR)) : bK;
                aB[bJ] = bB;
                bc[bJ] = bB.uniqueEndpoint;
                ae[bJ] = true;
                var bL = bH.dragEvents.stop,
                bP = bH.dragEvents.drag,
                bS = n.extend({},
                bB.dragOptions || {}),
                bN = bS.drag,
                bT = bS.stop,
                ...
                function() {
                    ...
                    if (bU.connections.length == 0) {
                        ...
                        var bW = bB.anchor || br.Defaults.Anchor,
                        bX = bU.anchor,
                        bZ = bU.connections[0];
                ...
                var bM = function(bZ) {
                    ...
                    b1 = ((bZ.pageY || bZ.page.y) - b3.top) / b3.height,
                    b7 = b2,
                    b6 = b1;
                    if (bB.parent) {
                        var b0 = bH.getElementObject(bB.parent),
                        bY = H(b0);
                        b3 = X({
                            elId: bY
                        });
                        b7 = ((bZ.pageX || bZ.page.x) - b3.left) / b3.width,
                        b6 = ((bZ.pageY || bZ.page.y) - b3.top) / b3.height
                    }
                    var b5 = {};
                    n.extend(b5, bB);
                    b5.isSource = true;
        ...
        var aP = function(bD, bC, bE, bz) {
            ...
            if (z(bC)) {
                ...
                if (bC.length) {
                    bC = aL(bC);
                    for (var bB = 0; bB < bC.length; bB++) {
                        var bF = _el = n.CurrentLibrary.getElementObject(bC[bB]),
                        bF = H(_el);
                        bA[bF] = bz ? !bA[bF] : bE
                    }
                }
        ...
        this.setId = function(bD, bz, bF) {
            ...
            bC = br.getConnections({
                source: bG,
                scope: "*"
            },
            true),
            bB = br.getConnections({
                target: bG,
                scope: "*"
            },
            true);
        ...
        var bs = function(bE, bB) {
            ...
            if (bC != null) {
                ...
                bD = bC.tagName.toLowerCase() === "body" ? {
                    left: 0,
                    top: 0
                }: {
                    left: bC.scrollLeft,
        ...
        var au = function(bB, bA, bG) {
            ...
            this.locked = false;
            var bC = bJ.length > 0 ? bJ[0] : null,
            bE = bJ.length > 0 ? 0 : -1,
            bI = this,
            bD = function(bQ, bN, bM, bR, bL) {
                var bK = bR[0] + (bQ.x * bL[0]),
                bS = bR[1] + (bQ.y * bL[1]),
                bP = bR[0] + (bL[0] / 2),
                bO = bR[1] + (bL[1] / 2);
        ...
        ao = function(bA, bz) {
            var bC = ag[bA],
            bD = aj[bA],
            bB = function(bK, bR, bG, bJ, bP, bO, bF) {
                if (bJ.length > 0) {
                    var bN = ar(bJ, a2[bK]),
                    bL = bK === "right" || bK === "top",
                    bE = a5(bK, bR, bG, bN, bP, bO, bL);
                    ...
                    for (var bH = 0; bH < bE.length; bH++) {
                        var bM = bE[bH][4],
                        bQ = bM.endpoints[0].elementId === bA,
        ...
        aG = function() {
            ...
            this.connectionDetached = function(bE) {
                ...
                bL = bF.targetId,
                bO = bF.endpoints,
                bJ = function(bP, bQ, bS, bR, bT) {
                    if (bS.constructor == a3) {} else {
                        A(bD[bR],
                        function(bU) {
                ...
                var bG = bF.sourceId,
                bH = bF.targetId,
                bN = bF.endpoints[0].id,
                bI = bF.endpoints[1].id,
                bM = function(bR, bP) {
                    if (bR) {
                        var bQ = function(bS) {
                            return bS[4] == bP
            ...
            this.redraw = function(bT, bV, bG, bJ) {
                if (!a9) {
                    ...
                    for (var b0 = 0; b0 < b3.length; b0++) {
                        ...
                        bN = bL.sourceId,
                        bI = bL.targetId,
                        bM = bL.endpoints[0].anchor.isContinuous,
                        bS = bL.endpoints[1].anchor.isContinuous;
                        if (bM || bS) {
                            var b1 = bN + "_" + bI,
                            bY = bI + "_" + bN,
                            bX = bQ[b1],
                            bR = bL.sourceId == bT ? 1 : 0;
                            if (bM && !bC[bN]) {
                                bC[bN] = {
                                    top: [],
                                    right: [],
        ...
        var az = function(bU) {
            ...
            var bD = aj[this.sourceId],
            bC = ag[this.sourceId],
            bz = aj[this.targetId],
            bH = ag[this.targetId],
            bI = bd || p(),
            bN = this.endpoints[0].anchor.compute({
                xy: [bD.left, bD.top],
                wh: bC,
            ...
            this.moveParent = function(bZ) {
                var bY = n.CurrentLibrary,
                bX = bY.getParent(bK.connector.canvas);
            ...
            this.paint = function(cd) {
                if (bB) {
                    ...
                    bX = cd.timestamp,
                    b6 = false,
                    cc = b6 ? this.sourceId: this.targetId,
                    b1 = b6 ? this.targetId: this.sourceId,
                    bY = b6 ? 0 : 1,
                    ce = b6 ? 1 : 0;
                    if (bX == null || bX != bJ) {
                        var cf = X({
                        ...
                        var b8 = this.endpoints[ce],
                        bW = this.endpoints[bY],
                        b0 = b8.anchor.getCurrentLocation(b8),
        ...
        var bh = function(bA) {
            ...
            return {
                drag: function() {
                    ...
                    var bB = n.CurrentLibrary.getUIPosition(arguments, br.getZoom()),
                    bC = bA.element;
                    if (bC) {
        ...
        var ah = function(b5) {
            ...
            this.makeInPlaceCopy = function() {
                var b9 = bS.anchor.getCurrentLocation(bS),
                b8 = bS.anchor.getOrientation(bS),
                b7 = {
                    compute: function() {
                        return [b9[0], b9[1]]
                    },
            ...
            this.paint = function(ca) {
                ...
                if (!cg || bS.timestamp !== cg) {
                    ...
                    if (cm) {
                        var cd = ca.anchorPoint,
                        cb = ca.connectorPaintStyle;
                        if (cd == null) {
                            ...
                            if (cf && bS.anchor.isDynamic && bS.connections.length > 0) {
                                var cj = bO(ca.elementWithPrecedence),
                                cl = cj.endpoints[0] == bS ? 1 : 0,
                                cc = cl == 0 ? cj.sourceId: cj.targetId,
                                ci = aj[cc],
                                ck = ag[cc];
            ...
            if (n.CurrentLibrary.isDragSupported(bR)) {
                ...
                var bH = function() {
                    ...
                    var cd = C(bG.canvas),
                    cb = s(cd, br),
                    b8 = bs([cb.left, cb.top], bG.canvas);
                    n.CurrentLibrary.setOffset(bX.element, {
                        left: b8[0],
                        top: b8[1]
                    });
                    if (bS.parentAnchor) {
                    ...
                    if (bW == null) {
                        ...
                        var ce = C(bS.canvas),
                        cc = n.CurrentLibrary.getDragScope(ce);
                ...
                var bD = n.CurrentLibrary,
                bZ = b5.dragOptions || {},
                bT = n.extend({},
                bD.defaultDragOptions),
                bV = bD.dragEvents.start,
                b4 = bD.dragEvents.stop,
                bK = bD.dragEvents.drag;
                bZ = n.extend(bT, bZ);
            ...
            var bI = function(b9, ce, cc, cf) {
                if ((b5.isTarget || ce) && n.CurrentLibrary.isDropSupported(bR)) {
                    ...
                    var b8 = n.CurrentLibrary.dragEvents.drop,
                    cd = n.CurrentLibrary.dragEvents.over,
                    b7 = n.CurrentLibrary.dragEvents.out,
                    cb = function() {
                        var cg = n.CurrentLibrary.getDropEvent(arguments),
                        ct = C(n.CurrentLibrary.getDragObject(arguments)),
                        ci = c(ct, "dragId"),
                        ck = c(ct, "elId"),
                        cs = c(ct, "originalScope"),
                        cn = bk[ci];
                        ...
                        if (cn != null) {
                            var cp = cn.floatingAnchorIndex == null ? 1 : cn.floatingAnchorIndex,
                            cq = cp == 0 ? 1 : 0;
                            if (cs) {
                            ...
                            if (!bS.isFull() && !(cp == 0 && !bS.isSource) && !(cp == 1 && !bS.isTarget) && cr) {
                                ...
                                var ch = function() {
                                    ...
                                    if (!cn.suspendedEndpoint) {
                                        ...
                                        var cw = cn.suspendedEndpoint.getElement(),
                                        cu = cn.suspendedEndpoint.elementId;
                                        ba({
                    ...
                    ca[cd] = ap(ca[cd],
                    function() {
                        var ch = n.CurrentLibrary.getDragObject(arguments),
                        ck = c(C(ch), "dragId"),
                        cj = bk[ck];
                        if (cj != null) {
    ...
    n.Anchors.Assign = q(0, 0, 0, 0, "Assign",
    function(I, J) {
    ...
    jsPlumb.Connectors.Straight = function() {
        ...
        var s = this,
        k = null,
        f, l, q, o, m, g, r, i, h, e, d, p, n;
        this.compute = function(B, K, t, A, G, u, E, z) {
            var J = Math.abs(B[0] - K[0]),
            D = Math.abs(B[1] - K[1]),
            C = 0.45 * J,
            v = 0.45 * D;
            J *= 1.9;
    ...
    jsPlumb.Connectors.Bezier = function(w) {
        ...
        this._findControlPoint = function(I, x, D, y, B, G, z) {
            var F = G.getOrientation(y),
            H = z.getOrientation(B),
            C = F[0] != H[0] || F[1] == H[1],
            A = [],
            J = q.majorAnchor,
            E = q.minorAnchor;
    ...
    jsPlumb.Connectors.Flowchart = function(A) {
        ...
        A = A || {};
        var s = this,
        e = A.stub || A.minStubLength || 30,
        k = jsPlumbUtil.isArray(e) ? e[0] : e,
        p = jsPlumbUtil.isArray(e) ? e[1] : e,
        u = A.gap || 0,
        f = A.midpoint || 0.5,
        v = [],
        n = 0,
        ...
        l = function(M, J, L, K, I, H) {
            var E = v.length == 0 ? L: v[v.length - 1][0],
            D = v.length == 0 ? K: v[v.length - 1][1],
            F = M == E ? Infinity: 0;
        ...
        this.compute = function(aa, ao, D, U, az, O, Y, T, au, aq) {
            ...
            H = (ae / 2) + (k + p),
            E = (ae / 2) + (p + k),
            R = az.orientation || az.getOrientation(D),
            aA = O.orientation || O.getOrientation(U),
            an = t ? ao[0] : aa[0],
            am = q ? ao[1] : aa[1],
            ap = Math.abs(ao[0] - aa[0]) + I + F,
            ay = Math.abs(ao[1] - aa[1]) + H + E;
            ...
            var M = t ? (ap - F) + (u * R[0]) : I + (u * R[0]),
            L = q ? (ay - E) + (u * R[1]) : H + (u * R[1]),
            aw = t ? I + (u * aA[0]) : (ap - F) + (u * aA[0]),
            av = q ? H + (u * aA[1]) : (ay - E) + (u * aA[1]),
            ad = M + (R[0] * k),
            ac = L + (R[1] * k),
            P = aw + (aA[0] * p),
            N = av + (aA[1] * p),
            Z = Math.abs(M - aw) > (k + p),
            ab = Math.abs(L - av) > (k + p),
            al = ad + ((P - ad) * f),
            aj = ac + ((N - ac) * f),
            S = ((R[0] * aA[0]) + (R[1] * aA[1])),
            af = S == -1,
            ...
            var at = [];
            var W = R[0] == 0 ? "y": "x",
            Q = af ? "opposite": G ? "orthogonal": "perpendicular",
            J = jsPlumbUtil.segment([M, L], [aw, av]),
            ak = R[W == "x" ? 0 : 1] == -1,
            V = {
                x: [null, 4, 3, 2, 1],
                y: [null, 2, 1, 4, 3]
    ...
    jsPlumb.Endpoints.Image = function(i) {
        ...
        n.canvas = document.createElement("img"),
        h = false;
        ...
        var m = function(r, q, p) {
            if (!g) {
                ...
                var o = n.anchorPoint[0] - (f / 2),
                s = n.anchorPoint[1] - (e / 2);
    ...
    jsPlumb.Endpoints.Triangle = function(d) {
        ...
        this.compute = function(k, g, m, i) {
            var h = m.width || self.width,
            f = m.height || self.height,
            e = k[0] - (h / 2),
            l = k[1] - (f / 2);
            return [e, l, h, f]
        }
        ...
        this.draw = function(m, s, w) {
            ...
            if (m.pointAlongPathFrom) {
                if (jsPlumbUtil.isString(e.loc) || e.loc > 1 || e.loc < 0) {
                    ...
                    y = m.pointAlongPathFrom(v, g * e.length / 2, true),
                    A = m.pointOnPath(v, true),
                    ...
                    if (e.loc == 1) {
                        ...
                        if (e.loc == 0) {
                            ...
                            y = m.pointAlongPathFrom(e.loc, g * e.length / 2),
                            A = m.pointOnPath(e.loc),
                            u = jsPlumbUtil.pointOnLine(y, A, e.length)
                        }
                    }
                }
                ...
                var q = Math.min(y.x, t[0].x, t[1].x),
                p = Math.max(y.x, t[0].x, t[1].x),
                o = Math.min(y.y, t[0].y, t[1].y),
                n = Math.max(y.y, t[0].y, t[1].y);
                var z = {
                    hxy: y,
                    tail: t,
                    cxy: k
                },
                x = f.strokeStyle || s.strokeStyle,
    ...
    jsPlumb.Connectors.StateMachine = function(l) {
        ...
        h = false,
        t = l.showLoopback !== false;
        this.type = "StateMachine";
        l = l || {};
        this.compute = function(ad, H, W, I, ac, z, v, U) {
            var Q = Math.abs(ad[0] - H[0]),
            Y = Math.abs(ad[1] - H[1]),
            S = 0.45 * Q,
            ab = 0.45 * Y;
            Q *= 1.9;
            Y *= 1.9;
            v = v || 1;
            var O = Math.min(ad[0], H[0]) - S,
            M = Math.min(ad[1], H[1]) - ab;
            if (!t || (W.elementId != I.elementId)) {
                ...
                R = (A == Infinity || A == -Infinity) ? 0 : Math.abs(d / 2 * Math.cos(V)),
                B = a(o, m, g, e),
        ...
        this.pointOnPath = function(x, B) {
            if (h) {
                ...
                var z = (x * 2 * Math.PI) + (Math.PI / 2),
                w = n[4] + (n[6] * Math.cos(z)),
        ...
        this.pointAlongPathFrom = function(D, v, C) {
            if (h) {
                ...
                var B = 2 * Math.PI * n[6],
                w = v / B * 2 * Math.PI,
                z = (D * 2 * Math.PI) - w + (Math.PI / 2),
                y = n[4] + (n[6] * Math.cos(z)),
                x = n[5] + (n[6] * Math.sin(z));
                return {
                    x: y,
                    y: x
                }
    ...
    var d = jsPlumb.SvgConnector = function(E) {
        ...
        this._paint = function(L, H) {
            ...
            if (H.outlineColor) {
                ...
                G = H.lineWidth + (2 * I),
                J = jsPlumb.CurrentLibrary.extend({},
                H);
    ...
    jsPlumb.Connectors.canvas.Straight = function() {
        ...
        this._paint = function(r, t) {
            ...
            if (t.dashstyle && t.dashstyle.split(" ").length == 2) {
                ...
                var C = [v[0] * t.lineWidth, v[1] * t.lineWidth],
                y = (r[6] - r[4]) / (r[7] - r[5]),
                G = jsPlumbUtil.segment([r[4], r[5]], [r[6], r[7]]),
                x = o[G],
                u = Math.atan(y),
                z = Math.sqrt(Math.pow(r[6] - r[4], 2) + Math.pow(r[7] - r[5], 2)),
                B = Math.floor(z / (C[0] + C[1])),
                w = [r[4], r[5]];
                for (var A = 0; A < B; A++) {
    ...
    window.jsBezier = {
        ...
        nearestPointOnCurve: function(m, l) {
            var n = h(m, l);
            return {
                point: k(l, l.length - 1, n.location, null, null),
                location: n.location
            }
        },
        pointOnCurve: c,
